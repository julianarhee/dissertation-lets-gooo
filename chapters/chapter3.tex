...
\section{Receptive field properties}
% ---------------------------------------------------------------
% RF properties
% ---------------------------------------------------------------
...
% Gratings
% ---------------------------------------------------------------
\section{Direction tuning and responses to gratings}
...
% I recorded in aenesthetized animals for a subset of localizer runs, but I do not provide direct comparisons between anesthetized and awake recordings for receptive field measurements here (though this could be a useful measurement to note for future studies). However,

% Interestingly, selectivity for various moving stimuli have been found across mouse higher-order visual areas, including area POR, which is typically associated with the ``ventral'' path framework (ventral/what, dorsal/where) framework, but is specialized for motion processing and does not receice inputs through which raises the interesting possibility that higher-order visual areas in rodents may be specialized for certain motion statistics 
