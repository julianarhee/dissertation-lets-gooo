...
\begin{figure}[t!]
    ...
    \textbf{A.} Schematic of imaging experiments in awake, head-fixed rats. 
    ...
    \textbf{C.} Example two-photon imaging field-of-view using the standard, large-FOV mode. The FOV is scaled for visualization purposes based its measured pixel size. Scale bar, 100$um$. 
    ...
    \textbf{F.} Cortical magnification of each imaging site recorded in areas V1, LM and LI (*: p<0.05, **: p<0.01, Mann-Whitney U-test, corrected for multiple comparisons). 
    \textbf{G.} Ratio of cortical magnification along elevation to azimuth for each imaging site. Conventions as in \textbf{F}.   \label{fig:2p_retino}}
\end{figure}
