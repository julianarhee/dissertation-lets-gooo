...
\begin{figure}[t!]
    ...
    \textbf{E.} Pseudo-colored image of retinotopic azimuth (left) and elevation (right) preference obtained by two-photon imaging with the cycling bar stimulus for a V1 FOV (FOV shown in \textbf{B} and \textbf{C}). Circles, locations of identified cell bodies, colors indicate preferred retinotopic locations. Background pixels contain a smoothed estimate of neuropil retinotopic preferences. 
