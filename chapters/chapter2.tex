...
\begin{figure}
    \includegraphics[width=\textwidth]{figures/chapter_2/fig_2-3_surgery_steps/surgery_steps.pdf}
    \vspace{.1in}
...
\begin{figure}
    \includegraphics[width=\textwidth]{figures/chapter_2/fig_2-4_headplate_schematic/headplate_schematic.pdf}
    \vspace{.1in}
