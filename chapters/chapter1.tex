...
\includegraphics[width=\textwidth]{figures/chapter_1/fig_1-3_behavior_generalization/fig_1-3_behavior_generalization.pdf}
    ...
    \textbf{H.} Accuracy as a function of the Nth presentation of a given transformation for feedback-provided (orange) and no-feedback (blue) conditions. Shading, SD across animals. Dashed line, 50\% accuracy, or chance performance.
